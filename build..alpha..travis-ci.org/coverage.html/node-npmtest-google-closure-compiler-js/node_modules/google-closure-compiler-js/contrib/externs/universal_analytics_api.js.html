...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-google-closure-compiler-js/node_modules/google-closure-compiler-js/contrib/externs/universal_analytics_api.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-google-closure-compiler-js/node_modules/google-closure-compiler-js/contrib/externs/universal_analytics_api.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-google-closure-compiler-js/node_modules/google-closure-compiler-js/contrib/externs/</a> &#187; universal_analytics_api.js</div>
</div>
<div class="body">
 ...
 * @interface
 */
var _ua_tracker = <span class="fstat-no" title="function not covered" >function() {</span>};
&nbsp;
/**
 ...
 */
_ua_tracker.prototype.get = <span class="fstat-no" title="function not covered" >function(name) {</span>};
&nbsp;
/**
 ...
 */
_ua_tracker.prototype.set = <span class="fstat-no" title="function not covered" >function(nameOrObj, value) {</span>};
&nbsp;
/**
 ...
 */
_ua_tracker.prototype.send = <span class="fstat-no" title="function not covered" >function(var_args) {</span>};
&nbsp;
/**
 ...
 * @return {undefined}
 */
var ga = <span class="fstat-no" title="function not covered" >function(var_args) {</span>};
&nbsp;
/**
 ...
 */
ga.create = <span class="fstat-no" title="function not covered" >function(var_args) {</span>};
&nbsp;
/**
 ...
 */
ga.getByName = <span class="fstat-no" title="function not covered" >function(name) {</span>};
&nbsp;
/**
 ...
 */
ga.getAll = <span class="fstat-no" title="function not covered" >function() {</span>};
&nbsp;
/**
 * Utility function that prints the contents of each tracker's model.
 * @return {undefined}
 */
ga.dump = <span class="fstat-no" title="function not covered" >function() {</span>};
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>
