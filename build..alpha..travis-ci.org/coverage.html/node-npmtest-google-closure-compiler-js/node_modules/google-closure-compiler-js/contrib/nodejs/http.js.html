...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-google-closure-compiler-js/node_modules/google-closure-compiler-js/contrib/nodejs/http.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-google-closure-compiler-js/node_modules/google-closure-compiler-js/contrib/nodejs/http.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-google-closure-compiler-js/node_modules/google-closure-compiler-js/contrib/nodejs/</a> &#187; http.js</div>
</div>
<div class="body">
 ...
 */
http.Server = <span class="fstat-no" title="function not covered" >function(listener) {</span>};
&nbsp;
/**
 ...
 */
http.IncomingMessage = <span class="fstat-no" title="function not covered" >function() {</span>};
&nbsp;
/**
 * @type {?string}
 * */
 ...
 * @private
 */
http.ServerResponse = <span class="fstat-no" title="function not covered" >function() {</span>};
&nbsp;
/**
 * @return {void}
 */
 ...
 * @private
 */
http.ClientRequest = <span class="fstat-no" title="function not covered" >function() {</span>};
&nbsp;
/**
 * @param {string|Array|Buffer} chunk
 * @param {string=} encoding
