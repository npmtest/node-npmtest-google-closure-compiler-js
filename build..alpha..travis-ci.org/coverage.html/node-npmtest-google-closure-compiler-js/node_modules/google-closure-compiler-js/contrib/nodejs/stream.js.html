...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-google-closure-compiler-js/node_modules/google-closure-compiler-js/contrib/nodejs/stream.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-google-closure-compiler-js/node_modules/google-closure-compiler-js/contrib/nodejs/stream.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-google-closure-compiler-js/node_modules/google-closure-compiler-js/contrib/nodejs/</a> &#187; stream.js</div>
</div>
<div class="body">
 ...
 */
stream.Stream = <span class="fstat-no" title="function not covered" >function(options) {</span>};
&nbsp;
/**
 ...
 */
stream.Readable = <span class="fstat-no" title="function not covered" >function(options) {</span>};
&nbsp;
/**
 * @type {boolean}
 * @deprecated
 ...
 */
stream.ReadableStream = <span class="fstat-no" title="function not covered" >function() {</span>};
&nbsp;
/**
 * @type {boolean}
 */
 ...
 * @extends stream.Stream
 */
stream.Writable = <span class="fstat-no" title="function not covered" >function(options) {</span>};
&nbsp;
/**
 * @deprecated
 * @type {boolean}
 ...
 */
stream.WritableStream = <span class="fstat-no" title="function not covered" >function() {</span>};
&nbsp;
/**
 * @return {void}
 */
 ...
 */
stream.Duplex = <span class="fstat-no" title="function not covered" >function(options) {</span>};
&nbsp;
/**
 * @type {boolean}
 */
 ...
 */
stream.Transform = <span class="fstat-no" title="function not covered" >function(options) {</span>};
&nbsp;
/**
 * @protected
 * @param {string|Buffer} chunk
 ...
 */
stream.PassThrough = <span class="fstat-no" title="function not covered" >function(options) {</span>};
&nbsp;
