...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-google-closure-compiler-js/node_modules/google-closure-compiler-js/contrib/nodejs/tls.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-google-closure-compiler-js/node_modules/google-closure-compiler-js/contrib/nodejs/tls.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-google-closure-compiler-js/node_modules/google-closure-compiler-js/contrib/nodejs/</a> &#187; tls.js</div>
</div>
<div class="body">
 ...
 * @constructor
 */
tls.CreateOptions = <span class="fstat-no" title="function not covered" >function () {</span>};
&nbsp;
/** @type {boolean} */
 ...
 * @return {void}
 */
tls.connect = <span class="fstat-no" title="function not covered" >function(port, host, options, callback) {</span>};
&nbsp;
/**
 ...
 */
tls.SecurePair = <span class="fstat-no" title="function not covered" >function() {</span>};
&nbsp;
/**
 * @constructor
 * @extends net.Server
 */
tls.Server = <span class="fstat-no" title="function not covered" >function() {</span>};
&nbsp;
/**
 ...
 * @return {void}
 */
tls.Server.prototype.addContext = <span class="fstat-no" title="function not covered" >function(hostname, credentials) {</span>};
&nbsp;
/**
 * @constructor
 * @extends stream.Duplex
 */
tls.CleartextStream = <span class="fstat-no" title="function not covered" >function() {</span>};
&nbsp;
/**
 * @type {boolean}
 */
